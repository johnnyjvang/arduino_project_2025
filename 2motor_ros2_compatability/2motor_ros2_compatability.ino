...
#define MOTOR_R_PWM 10  // Right motor PWM pin
#define MOTOR_R_IN1 5   // Right motor direction pin 1
#define MOTOR_R_IN2 6   // Right motor direction pin 2
...
void updateMotorSpeed(float targetL, float targetR) {
  ...
  // Constrain motor PWM between 0-255
  motorPWM_L = constrain(motorPWM_L, 0, 255);
  motorPWM_R = constrain(motorPWM_R, 0, 255);
